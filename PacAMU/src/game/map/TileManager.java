...
public class TileManager {
	...
	static Image ground_basic = new Image("file:res/img/Ground/Walkable/basic.png");
	static Image ground_u = new Image("file:res/img/Ground/Walkable/u.png");
	static Image ground_l = new Image("file:res/img/Ground/Walkable/l.png");
	static Image ground_r = new Image("file:res/img/Ground/Walkable/r.png");
	static Image ground_d = new Image("file:res/img/Ground/Walkable/d.png");
	static Image ground_dlu = new Image("file:res/img/Ground/Walkable/dlu.png");
	static Image ground_dr = new Image("file:res/img/Ground/Walkable/dr.png");
	static Image ground_ld = new Image("file:res/img/Ground/Walkable/ld.png");
	static Image ground_ldr = new Image("file:res/img/Ground/Walkable/ldr.png");
	static Image ground_lr = new Image("file:res/img/Ground/Walkable/lr.png");
	static Image ground_lu = new Image("file:res/img/Ground/Walkable/lu.png");
	static Image ground_lur = new Image("file:res/img/Ground/Walkable/lur.png");
	static Image ground_ud = new Image("file:res/img/Ground/Walkable/ud.png");
	static Image ground_ur = new Image("file:res/img/Ground/Walkable/ur.png");
	static Image ground_urd = new Image("file:res/img/Ground/Walkable/urd.png");


	
	private static void init() {
		for( int i=1 ; i<7 ; i++ ) {
			String name = "file:res/img/Ground/Unwalkable/grass" + i + ".png";
